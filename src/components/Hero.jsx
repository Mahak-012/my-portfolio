...
function Hero() {
  ...
  return (
    <section
      ...
      className="min-h-screen py-28 md:py-36 px-4 sm:px-12 md:px-16 lg:px-24 relative overflow-hidden bg-gradient-to-b from-[#020a06] via-[#010704] to-[#020a06] text-white flex items-center select-none"
    >
      <style>{`
        .green-glow-card {
        ...
        .animate-entrance {
          animation: fadeUpIn 0.85s cubic-bezier(.22,1,.36,1) both;
        }
        @keyframes nameGlow {
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle at ${spot.x}% ${spot.y}%, rgba(52,211,153,0.10), transparent 32%)`,
        }}
      />
      <div
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        <div className="lg:col-span-7 flex flex-col items-start space-y-6 md:space-y-8">
          <div
            className="animate-entrance inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-950/40 border border-emerald-500/30 backdrop-blur-md"
          ...
          <p
            className="animate-entrance text-emerald-100/70 text-sm sm:text-base leading-relaxed max-w-xl font-light tracking-wide"
          ...
          <div className="animate-entrance flex flex-wrap gap-4 pt-2 w-full" style={{ animationDelay: "0.42s" }}>
            <a
              href="#projects"
              className="green-glow-btn relative overflow-hidden px-6 py-3 rounded-xl text-white text-sm font-semibold tracking-wide"
            >
              <span
                className="absolute top-0 left-0 h-full w-1/3 animate-button-shine pointer-events-none"
            ...
            <a
              href="#contact"
              className="animate-soft-pulse px-6 py-3 rounded-xl border border-emerald-500/20 bg-emerald-950/10 text-emerald-300 text-sm font-medium tracking-wide hover:border-emerald-500/50 hover:bg-emerald-950/30 transition-all duration-300"
            >
              Let's Connect
            </a>
            <a
              href="/resume.pdf"
              download
              className="px-6 py-3 rounded-xl border border-zinc-800 bg-zinc-950/30 text-zinc-300 text-sm font-medium tracking-wide hover:border-zinc-700 hover:bg-zinc-900/40 transition-all duration-300 flex items-center gap-2"
            >
              Download CV ↓
            </a>
          </div>
          <div
            className="animate-entrance grid grid-cols-3 gap-4 sm:gap-8 pt-8 border-t border-emerald-950/40 w-full max-w-md"
        ...
        <div className="lg:col-span-5 flex justify-center items-center lg:justify-end pt-8 lg:pt-0 animate-entrance" style={{ animationDelay: "0.3s" }}>
          <div
            ref={frameRef}
            onMouseMove={handleFrameMouseMove}
            onMouseLeave={handleFrameMouseLeave}
            className="relative w-[340px] h-[340px] sm:w-[400px] sm:h-[400px] md:w-[480px] md:h-[480px] lg:w-[520px] lg:h-[520px] flex items-center justify-center"
            style={{
          ...
          >
            <div
              ...
              style={{ background: "radial-gradient(circle, rgba(16,185,129,0.35) 0%, transparent 70%)", filter: "blur(28px)" }}
            />
            <div
            ...
            />
            <div className="absolute inset-6 rounded-[2.5rem] border border-emerald-500/30 bg-gradient-to-b from-[#02130b] to-[#010704] p-3 shadow-[0_0_60px_rgba(4,120,87,0.2)] overflow-hidden z-10">
              <div className="w-full h-full rounded-[2rem] overflow-hidden bg-zinc-950 relative border border-emerald-500/10">
                <img
                  src={profileImg}

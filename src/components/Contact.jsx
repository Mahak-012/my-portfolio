...
function Contact() {
  ...
  const socialLinks = [
    ...
    { name: "Instagram", icon: <InstagramIcon />, link: "https://www.instagram.com/mahak_codes22?igsi=MTc3NDM1aTI4Z2s2dg==" },
  ];
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    title={social.name}
                    className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:-translate-y-1 text-emerald-400"
                    style={{
